...
After the last transition of your last saltem hoc speculation, transition toward the edge using one of the following (choose only one per image and state your choice):
