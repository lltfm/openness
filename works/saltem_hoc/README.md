...
[LLM AI prompt for Openness GPT](openness_gpt/openness_gpt-prompt-v11.txt). Openness GPT is
...
1. Copy the [prompt text](openness_gpt/openness_gpt-prompt-v11.txt) to the clipboard:
